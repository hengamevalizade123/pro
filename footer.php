	...
	<div class="o-section__wrapper">
		<div class="c-footer">
			<div class="c-footer__bottom u-flex gap-lg items-start">
					...
					<ul class="u-flex gap-sm u-flex--column">
						<li>
							<p class="m-0">
								...
								تهران انتهای اشرفی اصفهانی سیمون بولیوار خیابان فکوری نبش یکم غربی پلاک ۴۰ واحد ۳
							</p>
						</li>
				...
				<div class="c-footer__col">
					<ul class="p-0 u-flex wrap gap-md m-0 space-between">
...
<svg height="40px" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 8552.71 3770.5"><g><path
			...
			transform="translate(-0.38 -0.12)" fill="#ef7f1a" fill-rule="evenodd"></path><path
			...
			transform="translate(-0.38 -0.12)" fill="#fff" fill-rule="evenodd"></path><path
			...
			transform="translate(-0.38 -0.12)" fill="#fff" fill-rule="evenodd"></path></g></svg>						</span>
