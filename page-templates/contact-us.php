...
?>
	<section class="o-section c-section--main-page pt-0">
		<div class="o-section__wrapper">
			...
			<p class="c-contact-desc txt-justify">
				از راه‌های ارتباطی زیر با مشاوران و متخصصان ما در حوزه برق در تماس باشید. ما آماده پاسخ‌گویی به شما هستیم.
			</p>
			<div class="c-contact d-flex gap-md bg-white">
				<div class="c-contact__form padding-md flex-1 u-flex items-center">
				...
				<div class="c-contact__info padding-md flex-1">
					...
					<p class="d-flex gap-sm items-start mt-0">
						...
						اشرفی اصفهانی، سیمون بولیوار، ابتدای خیابان فکوری، نبش کوچه یکم غربی، پلاک ۴۰ واحد ۳
					</p>
					...
					<p class="d-flex gap-sm items-start">
						...
						<a href="mailto:pro@barghapp.com">
							pro@barghapp.com
						</a>
					</p>
				</div>
