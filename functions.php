...
function starter_theme_widgets_init() {
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'videoription'   => esc_html__( 'Add widgets here.', 'starter-theme' ),
...
add_action('init', 'disable_embeds_code', 9999);
...
// woff allow to upload
function allow_woff_uploads($mimes) {
	$mimes['woff']  = 'font/woff';
	$mimes['woff2'] = 'font/woff2';
	return $mimes;
}
add_filter('upload_mimes', 'allow_woff_uploads');
