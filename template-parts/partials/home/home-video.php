<section class="o-section c-section--home-video">
	<div class="o-section__wrapper">
		<div class="c-home-video border-radius">
					...
					<div class="play-btn" id="playBtn">
						<svg width="121" height="120" viewBox="0 0 121 120" fill="none"
							...
							<path
								...
								fill="white" fill-opacity="0.58" stroke="#77B042" stroke-width="3.70514"/>
			...
			<?php if (have_rows('video-box')): ?>
				<?php while (have_rows('video-box')): the_row();
					$img_right = get_sub_field('img-video-right');
					$img_left = get_sub_field('img-video-left');
					?>
					<img class="img-video-bef img-video-left" src="<?php echo $img_right["url"] ?>"
						 alt="<?php echo $img_right["alt"] ?>">
					<img class="img-video-bef img-video-right" src="<?php echo $img_left["url"] ?>"
						 alt="<?php echo $img_left["alt"] ?>">
				<?php endwhile; ?><?php endif; ?>
		</div>
	</div>
</section>
