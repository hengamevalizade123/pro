			...
			<div class="c-home-steps__content relative w-100">
				<ul class="p-0 m-0 u-flex wrap gap-md space-between">
					...
					<li>
						...
						<p>
							امکان رویت و مدیریت هوشمند تولید روزانه نیروگاه در برقاپ پرو
						</p>
					</li>
					<li>
						<span>
						...
						<p>
							امکان فروش میزان برق تولیدی در سبد های پیشنهادی برقاپ پرو و رسیدن به حاشیه سود مطلوب
						</p>
					</li>
					<li>
						<span>
						...
						<p>
							از بین رفتن جرائم عدم تولید نیروگاه با اتکا به نیروگاه مجازی برقاپ پرو
						</p>
					</li>
					<li>
						<span>
